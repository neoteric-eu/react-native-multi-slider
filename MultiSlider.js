...
export default class MultiSlider extends React.Component {
  static propTypes = {
    ...
    maxDiffInTwoPoints: PropTypes.number
  };
  ...
  moveOne = gestureState => {
    ...
    const {maxDiffInTwoPoints} = this.props;
    var bottom = 0;
    ...
    if (Math.abs(gestureState.dy) < slipDisplacement || !slipDisplacement) {
      ...
      if (maxDiffInTwoPoints && value + maxDiffInTwoPoints > this.state.valueTwo) {
        return;
      }
  ...
  moveTwo = gestureState => {
    ...
    if (Math.abs(gestureState.dy) < slipDisplacement || !slipDisplacement) {
      ...
      if (maxDiffInTwoPoints && value - maxDiffInTwoPoints < this.state.valueOne) {
        return;
      }
